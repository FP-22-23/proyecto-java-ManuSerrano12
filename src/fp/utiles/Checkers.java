...
public class Checkers {
	...
	/**
	 * @param textoRestriccion Mensaje que se incluir� en la excepci�n elevada
	 * @param condicion        Expresi�n booleana que ha de cumplirse para que no
	 *                         se eleve una excepci�n
	...
	/**
	 * @param parametros Lista de par�metros para los que se quiere realizar una
	 *                   comprobaci�n de nulidad.
